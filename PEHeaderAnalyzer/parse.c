            ...
            else
            {
                if (anSize[i] == sizeof(WORD))
                {
                    ...
                    if (i == 19)
                    {
                        ...
                        if ((temp & (4 << 4)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE, "IMAGE_DLLCHARACTERISTICS_DYNAMIC_BASE");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (8 << 4)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY, "IMAGE_DLLCHARACTERISTICS_FORCE_INTEGRITY");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (1 << 8)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_NX_COMPAT, "IMAGE_DLLCHARACTERISTICS_NX_COMPAT");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (2 << 8)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_NO_ISOLATION, "IMAGE_DLLCHARACTERISTICS_NO_ISOLATION");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (4 << 8)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_NO_SEH, "IMAGE_DLLCHARACTERISTICS_NO_SEH");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (8 << 8)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_NO_BIND, "IMAGE_DLLCHARACTERISTICS_NO_BIND");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (2 << 12)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_WDM_DRIVER, "IMAGE_DLLCHARACTERISTICS_WDM_DRIVER");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                        if ((temp & (8 << 12)) != 0)
                        {
                            sprintf(a, "\n%*s %04x \t\t%s", WIDTH - 9, "", IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE, "IMAGE_DLLCHARACTERISTICS_TERMINAL_SERVER_AWARE");
                            strncat(buf, a, strlen(a));
                            memset(a, 0, sizeof(a));
                        }
                    }
                ...
                else
                {
                    sprintf(buf, "[%08X] %s 0x%08X",
                            offset, pcszFld[i], *((LPDWORD)pIter), i);
                }
            }
        }
        printf("%s\n", buf);
    ...
    for (INT i = 0; i < secCnt; i++)
    {
        ...
        for (INT i = 0; i < cnt; i++)
        {
            ...
            else
            {
                ...
                if (i == 8)
                {
                    DWORD temp = *((LPDWORD)pIter);
                    BYTE a[128] = {
                        0,
                    };
                    if ((temp & (8 << 0)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_TYPE_NO_PAD, "IMAGE_SCN_TYPE_NO_PAD");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (2 << 4)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_CNT_CODE, "IMAGE_SCN_CNT_CODE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (4 << 4)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_CNT_INITIALIZED_DATA, "IMAGE_SCN_CNT_INITIALIZED_DATA");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (8 << 4)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_CNT_UNINITIALIZED_DATA, "IMAGE_SCN_CNT_UNINITIALIZED_DATA");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (1 << 8)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_LNK_OTHER, "IMAGE_SCN_LNK_OTHER");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (2 << 8)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_LNK_INFO, "IMAGE_SCN_LNK_INFO");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (8 << 8)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_LNK_REMOVE, "IMAGE_SCN_LNK_REMOVE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (1 << 12)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_LNK_COMDAT, "IMAGE_SCN_LNK_COMDAT");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (4 << 12)) != 0)
                    ...
                    if ((temp & (8 << 12)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_GPREL, "IMAGE_SCN_GPREL");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (2 << 16)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_PURGEABLE, "IMAGE_SCN_MEM_PURGEABLE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (4 << 16)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_LOCKED, "IMAGE_SCN_MEM_LOCKED");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (8 << 16)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_PRELOAD, "IMAGE_SCN_MEM_PRELOAD");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }

                    
                    if ((temp & (14 << 20)) == IMAGE_SCN_ALIGN_8192BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_8192BYTES, "IMAGE_SCN_ALIGN_8192BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (13 << 20)) == IMAGE_SCN_ALIGN_4096BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_4096BYTES, "IMAGE_SCN_ALIGN_4096BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (12 << 20)) == IMAGE_SCN_ALIGN_2048BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_2048BYTES, "IMAGE_SCN_ALIGN_2048BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (11 << 20)) == IMAGE_SCN_ALIGN_1024BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_1024BYTES, "IMAGE_SCN_ALIGN_1024BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (10 << 20)) == IMAGE_SCN_ALIGN_512BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_512BYTES, "IMAGE_SCN_ALIGN_512BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (9 << 20)) == IMAGE_SCN_ALIGN_256BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_256BYTES, "IMAGE_SCN_ALIGN_256BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (8 << 20)) == IMAGE_SCN_ALIGN_128BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_128BYTES, "IMAGE_SCN_ALIGN_128BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (7 << 20)) == IMAGE_SCN_ALIGN_64BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_64BYTES, "IMAGE_SCN_ALIGN_64BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (6 << 20)) == IMAGE_SCN_ALIGN_32BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_32BYTES, "IMAGE_SCN_ALIGN_32BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (5 << 20)) == IMAGE_SCN_ALIGN_16BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_16BYTES, "IMAGE_SCN_ALIGN_16BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (4 << 20)) == IMAGE_SCN_ALIGN_8BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_8BYTES, "IMAGE_SCN_ALIGN_8BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (3 << 20)) == IMAGE_SCN_ALIGN_4BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_4BYTES, "IMAGE_SCN_ALIGN_4BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (2 << 20)) == IMAGE_SCN_ALIGN_2BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_2BYTES, "IMAGE_SCN_ALIGN_2BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    else if ((temp & (1 << 20)) == IMAGE_SCN_ALIGN_1BYTES)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_ALIGN_1BYTES, "IMAGE_SCN_ALIGN_1BYTES");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    ...
                    if ((temp & (1 << 24)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_LNK_NRELOC_OVFL, "IMAGE_SCN_LNK_NRELOC_OVFL");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (2 << 24)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_DISCARDABLE, "IMAGE_SCN_MEM_DISCARDABLE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (4 << 24)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_NOT_CACHED, "IMAGE_SCN_MEM_NOT_CACHED");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (8 << 24)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_NOT_PAGED, "IMAGE_SCN_MEM_NOT_PAGED");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (1 << 28)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_SHARED, "IMAGE_SCN_MEM_SHARED");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (2 << 28)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_EXECUTE, "IMAGE_SCN_MEM_EXECUTE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (4 << 28)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_READ, "IMAGE_SCN_MEM_READ");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                    if ((temp & (8 << 28)) != 0)
                    {
                        sprintf(a, "\n%*s %08x \t\t%s", WIDTH - 9, "", IMAGE_SCN_MEM_WRITE, "IMAGE_SCN_MEM_WRITE");
                        strncat(buf, a, strlen(a));
                        memset(a, 0, sizeof(a));
                    }
                }
